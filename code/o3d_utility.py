...
def visualize_icp(source_points, target_points, T, save = ""):
    ...
    vis.create_window()
    vis.add_geometry(pcd_source.transform(flip_transform))
    vis.add_geometry(pcd_target.transform(flip_transform))
