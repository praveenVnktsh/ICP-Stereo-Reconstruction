...
if __name__ == '__main__':
    ...
    vis.run()
    vis.capture_screen_image(fr'E:\dev\slam_icpp\images\slam/merged_{args.start_idx}_{args.end_idx}.png')
    ...
    plt.savefig(fr'E:\dev\slam_icpp\images\slam/trajectory_{args.start_idx}_{args.end_idx}.png')
    plt.show()
